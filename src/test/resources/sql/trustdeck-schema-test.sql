...
-- DROP DATABASE trustdeck;
--
-- Name: trustdeck; Type: DATABASE; Schema: -; Owner: trustdeck-manager
--
-- CREATE DATABASE trustdeck WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';
...
ALTER TABLE public.auditevent_id_seq OWNER TO "trustdeck-manager";
...
CREATE TABLE public.algorithm (
    ...
    CONSTRAINT algorithm_configuration_key UNIQUE (name, alphabet, random_algorithm_desired_size, random_algorithm_desired_success_probability, pseudonym_length, padding_character, add_check_digit, length_includes_check_digit, salt, salt_length)
);
...
ALTER TABLE public.domain_id_seq OWNER TO "trustdeck-manager";
...
ALTER TABLE public.pseudonym_id_seq OWNER TO "trustdeck-manager";
...
INSERT INTO public.algorithm (id, name, alphabet, random_algorithm_desired_size, random_algorithm_desired_success_probability, consecutive_value_counter, pseudonym_length, padding_character, add_check_digit, length_includes_check_digit, salt, salt_length) VALUES
(1, 'MD5', 'ABCDEF0123456789', 100000000, 0.99999998, 1, 32, '0', true, false, 'azMPTIQXJsept_4nDj5B1BXN83Bj_8VJ', 32);

INSERT INTO public.domain
(name, prefix, validfrom, validfrominherited, validto, validtoinherited, enforcestartdatevalidity, enforcestartdatevalidityinherited, enforceenddatevalidity, enforceenddatevalidityinherited, algorithm_id, algorithm_inherited, multiplepsnallowed, multiplepsnallowedinherited, description, superdomainid) VALUES
('TestStudie', 'TS-', '2022-02-26 19:15:20.885853', false, '2052-02-19 19:15:20.885853', false, true, false, true, false, 1, false, false, false, NULL, NULL);
