...
public class Indexes {
    ...
    public static final Index LINKAGE_TOKEN_ENTITY_IDX = Internal.createIndex(DSL.name("linkage_token_entity_idx"), LinkageToken.LINKAGE_TOKEN, new OrderField[] { LinkageToken.LINKAGE_TOKEN.ENTITY_TYPE_ID, LinkageToken.LINKAGE_TOKEN.ENTITY_ID }, false);
