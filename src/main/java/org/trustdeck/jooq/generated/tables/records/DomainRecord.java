...
public class DomainRecord extends UpdatableRecordImpl<DomainRecord> implements Record18<Integer, String, String, LocalDateTime, Boolean, LocalDateTime, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, String, Integer, Integer, Boolean, Integer>, IDomain {
    ...
    @Override
    public Row18<Integer, String, String, LocalDateTime, Boolean, LocalDateTime, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, String, Integer, Integer, Boolean, Integer> valuesRow() {
    ...
    @Override
    public DomainRecord value12(Boolean value) {
    ...
    @Override
    public DomainRecord value14(String value) {
        setDescription(value);
        return this;
    }

    @Override
    public DomainRecord value15(Integer value) {
        setSuperdomainid(value);
        return this;
    }

    @Override
    public DomainRecord value16(Integer value) {
        setAlgorithmId(value);
        return this;
    }

    @Override
    public DomainRecord value17(Boolean value) {
     ...
     */
    public DomainRecord(Integer id, String name, String prefix, LocalDateTime validfrom, Boolean validfrominherited, LocalDateTime validto, Boolean validtoinherited, Boolean enforcestartdatevalidity, Boolean enforcestartdatevalidityinherited, Boolean enforceenddatevalidity, Boolean enforceenddatevalidityinherited, Boolean multiplepsnallowed, Boolean multiplepsnallowedinherited, String description, Integer superdomainid, Integer algorithmId, Boolean algorithmInherited, Integer projectId) {
        super(Domain.DOMAIN);
